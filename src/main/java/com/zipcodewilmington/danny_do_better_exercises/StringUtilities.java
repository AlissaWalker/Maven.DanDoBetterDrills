...
public class StringUtilities {
    ...
    public static String getPrefix(String input) {
        //sub string takes string and returns a new string
     ...
     */
    //the system has to look at each character thats why there is a char
    // char looks at each individual letter
